...
3. "Sorry, could you say that again a little slower?"
4. "Let me make sure I got that."
5. "So that's… [repeat the order back]"
6. "How would you like that cooked?"
7. "Was that with fries or a salad?"
8. "Anything else for you?"

---

## COLD OPEN — HOOK (0:00–0:25)

**[SCENE: Restaurant floor, lunch rush energy. Maria at a table, order pad ready. VOICE OF CUSTOMER = James's voice, fast.]**

**CUSTOMER (very fast, realistic speed):** "Yeah-can-I-get-the-double-bacon-burger-no-onions-extra-pickles-with-a-side-Caesar-instead-of-fries-and-an-iced-tea-half-sweet?"

**[FREEZE FRAME on Maria's face. Record-scratch beat.]**
...
## PART 1 — THE FRAME (0:25–1:10)

**[SCENE: Empty restaurant, pre-shift. Morning light. James and Maria at the service counter with coffee.]**

**JAMES:** Maria, you're on the floor solo today. How are you feeling?

**MARIA:** Honestly? Nervous. When customers speak fast, my brain just… stops.
...
**JAMES:** That's it. Let's practice each one. I'll be your customer — and I won't go easy on you.

---

## PART 2 — SKILL 1: CONTROL THE START (1:10–2:40)
...
**JAMES (as customer):** Uh, almost — give us a minute?
...
**JAMES (as customer):** Sure, an iced tea.

**JAMES (as himself):** See what happened? Two phrases in, and the conversation is calm, and it's moving at YOUR speed.

---

## PART 3 — SKILL 2: SLOW THEM DOWN POLITELY (2:40–4:20)

**JAMES (as himself):** Now the part you're scared of. I'm going to order fast. Ready?

**JAMES (as customer, fast):** "Can-I-get-the-club-sandwich-no-mayo-add-avocado-and-a-lemonade?"
...
**JAMES (as customer, slower):** Sure — club sandwich, no mayo, add avocado. And a lemonade.
...
**JAMES (as customer):** Add avocado.

**JAMES (as himself):** Perfect. You only asked for the piece you missed. Fast, professional, confident.
...
**MARIA:** How would you like that cooked?

**JAMES (as customer):** Medium.

**MARIA:** Was that with fries or a salad?

**JAMES (as customer):** Fries.

**MARIA:** Anything else for you?

**JAMES (as customer):** No, that's everything.

**MARIA:** So that's one burger, medium, with fries. Coming right up!

**JAMES (as himself):** THAT is a professional server. Speed never mattered — you controlled the whole thing.

---

## PART 5 — THE PAYOFF (5:50–6:30)

**[SCENE: Return to the cold-open moment. Lunch rush. Same fast customer line.]**

**MARIA (VO):** Remember this guy?

**JAMES (as customer, very fast — same line as cold open):** "Yeah-can-I-get-the-double-bacon-burger-no-onions-extra-pickles-with-a-side-Caesar-instead-of-fries-and-an-iced-tea-half-sweet?"

**MARIA (calm):** Let me make sure I got that — double bacon burger, no onions, extra pickles…

**JAMES (as customer):** Yep.

**MARIA:** Was that a Caesar salad instead of the fries?

**JAMES (as customer):** Exactly.

**MARIA:** And an iced tea, half sweet. Anything else for you?

**JAMES (as customer):** No — wow, you got all that?

**MARIA (small smile, to camera):** Every word.

---

## RECAP SEGMENT — ANIMATED WHITEBOARD QUIZ (6:30–7:40)

**[REQUIRED SEGMENT — every episode. SCENE: Maria and James side by side at the counter, whiteboard fills the frame behind/beside them. Q → PAUSE (3s) → A rhythm. Question appears written on the whiteboard as it's asked; answer writes itself after the pause.]**

**JAMES:** Recap time. I ask, you answer — out loud, right now, wherever you are.

**JAMES:** Question one: a customer sits down. What's the FIRST thing you say?
**[WHITEBOARD writes the question. 3-SECOND PAUSE — quiet tick]**
**MARIA:** "Are you ready to order?" — or buy time with: "Can I get you started with something to drink?"

**JAMES:** Question two: the customer speaks too fast. What's your magic phrase?
**[PAUSE — 3s]**
**MARIA:** "Sorry, could you say that again a little slower?"

**JAMES:** Question three: you understood HALF the order. What do you say?
**[PAUSE — 3s]**
**MARIA:** "Let me make sure I got that…" — then confirm the part you heard, and ask only for the missing piece.

**JAMES:** Question four: before you walk away from the table — what must you always do?
**[PAUSE — 3s]**
**MARIA:** Repeat the order back: "So that's…"

**JAMES:** Last one: the customer orders a burger. Two questions you should ask?
**[PAUSE — 3s]**
**MARIA:** "How would you like that cooked?" and "Was that with fries or a salad?"

**[WHITEBOARD: all 8 phrases now visible as the completed board]**

---

## OUTRO + CTA (7:40–8:10)

**MARIA:** Next shift, pick just ONE of these phrases and use it with a real customer. Then come back and tell us which one in the comments — we read every single one.

**JAMES:** Next episode: the customer isn't fast — the customer is ANGRY. We'll give you the exact de-escalation phrases that work.

**MARIA:** Subscribe so you don't miss it. We're Two Colleagues —

**JAMES:** — and we'll see you at work.
...
- How to Take an Order in English — Even When the Customer Speaks Fast *(handoff title — default)*
- Restaurant English for Servers: Take Any Order at Any Speed
- Customers Speak Too Fast? 8 Server Phrases That Fix It

**Description draft:** Real restaurant English for servers — not textbook drills. Learn the 8 phrases that let you take any order, even from fast-speaking customers: how to control the conversation, politely slow customers down, and repeat orders back like a pro. For waiters, servers, and restaurant workers using English at work (B1–B2).

**Tags (starter set):** restaurant english, english for servers, english for waiters, work english, workplace english, take an order in english, english for restaurant workers, ESL work english, english speaking practice, two colleagues english
